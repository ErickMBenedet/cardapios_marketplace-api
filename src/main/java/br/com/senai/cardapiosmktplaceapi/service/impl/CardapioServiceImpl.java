...
import br.com.senai.cardapiosmktplaceapi.entity.dto.CardapioSalvo;
import br.com.senai.cardapiosmktplaceapi.entity.dto.NovaOpcaoDoCardapio;
import br.com.senai.cardapiosmktplaceapi.entity.dto.NovoCardapio;
...
public class CardapioServiceImpl implements CardapioService{
	...
	private Restaurante getRestaurantePor(NovoCardapio novoCardapio) {
		...
		Restaurante restaurante = restaurantesRepository.buscarPor(novoCardapio.getRestaurante().getNome());
	...
	public Cardapio alterar(CardapioSalvo cardapioSalvo) {
		...
		cardapio.setRestaurante(restaurante);
		cardapio.setStatus(cardapioSalvo.getStauts());
	...
	public void atualizarStatusPor(Integer id, Status status) {
		...
		Preconditions.checkNotNull(cardapio, "Não foi encontrado cardápio com o id informado");
		Preconditions.checkArgument(cardapio.getStatus() != status, "O stauts informado já foi salvo anteriormente");
