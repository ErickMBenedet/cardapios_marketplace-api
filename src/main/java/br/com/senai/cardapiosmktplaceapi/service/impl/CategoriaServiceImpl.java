...
public class CategoriaServiceImpl implements CategoriaService{
	...
	@Override
	public Categoria salvar(@NotNull(message = "A categoria é obrigatória") Categoria categoria) {
		Categoria outraCategoria = repository.buscarPor(categoria.getNome(), categoria.getTipo());
		if(outraCategoria != null) {
			Preconditions.checkArgument(outraCategoria.equals(categoria), "O nome da categoria já está em uso");
		}
